...
const ProfileGen = () => {
  ...
  let [isCompleted, SetisCompletetd] = useState(true)
  ...
  function handleJDCreation() {
    SetisCompletetd(false)
  }
                  ...
                  <div className="flex items-center">
                    ...
                    {index < steps.length - 1 && (
                      <div className={`step-line mx-4 
                        ${stepNumber.includes(step+1) ? 'bg-blue-500' : 'bg-white'}`} />
                    )}
                  </div>
                </React.Fragment>
              ))}
